...
<div class="content forecast-single-content">
        ...
        <div class="content-inner justify-content-between">
            <div>
                ...
                <div class="current-msg">
                    <h1 class="main-msg secondary-color">{{ $data['text'] }} <span class="main-color">{{ $data['last'] }}.</span></h1>
            ...
            <div>
                <div class="mini-forecast">
                    <div class="forecast tomorrow-forecast dark-bg">
                        ...
                        <div class="forecast-minidesc">{{ $data["small_1"] }}</div>
                    </div>
                    <div class="forecast tomorrow-forecast main-bg">
                        ...
                        <div class="forecast-minidesc">{{ $data["small_2"] }}</div>
                    </div>
                    <div class="forecast tomorrow-forecast dark-bg">
                        ...
                        <div class="forecast-minidesc">{{ $data["small_3"] }}</div>
                    </div>
                </div>
        ...
        <div class="content-inner">
            ...
            <div class="title">
                <h1 class="secondary-color">NINETYNINE</h1>
                <h1 class="main-color">WEATHER</h1>
            </div>
            <div class="subtitle">
                <h2>Η πόλη δεν βρέθηκε.</h2>
            </div>
        </div>
        @endif
</div>
